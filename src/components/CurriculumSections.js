        ...
        <div className="wrapper">
          ...
          <div className="half">
            ...
            <div className="tab">
              ...
              <label htmlFor="tab-one" className="curriculum-label">
                Module 1: Gain an in-depth knowledge of Git, Ruby, HTML & SQL
              </label>
              <label htmlFor="tab-one" className="curriculum-label-mobile">
                Module 1: Git, Ruby, HTML & SQL
              </label>
              ...
              <div className="tab-content">
                <div className="row">
                  <div className="column-left curriculum-text">
                    ...
                    <p>Begin your journey by learning version control & GIT as you
                      dive deep into object-orientation in Ruby. Create & manipulate databases
                      as you learn how to efficiently debug applications. Master the building
                      blocks of the web and become fluent in HTML & CSS.
                    </p>

...
const About = () => (
  ...
  <h6 className="bold-text about-font">Software Engineer</h6>
  </div>
  </div>
  <p className="about-p">
  ...
  <p className="about-p">
  If you have a summer off from high school, come to take an immersive AP Computer Science bootcamp. We will teach you everything to pass the AP exam. Its credits can be transferred into most colleges to save you money down the road. Or you may even take our immersive, 5 days a week, hands-on bootcamp for 8 weeks. You will learn the full-stack web development technologies both front-end and back-end. Upon completion, you will have built a portfolio of projects to show your passion and make you stand out from the crowd in your college applications.

  </p>

  <p className="about-p">
  If you’re thinking about a career change, you may consider our immersive, 15-week, bootcamp. Come talk to us. We will explain how.
  </p>

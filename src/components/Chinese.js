    ...
    <>
      <div className="intro-java-gradient" style={{paddingBottom:"1vw"}}>
          ...
          <div className="course-top-right-chinese">
            <Slide left>
              <p className="course-paragraph course-paragraph-left" style={{color:"white", width:"100%", textAlign:"left"}}>
                ...
                <p> 编程是社会的方向。人工智能是大势，很多职业在被淘汰，而编程行业是一枝独秀，欣欣向荣。</p>
                <p> 不管孩子将来学什么，做什么，编程都有用。我的两个孩子大学毕业后做研究及工作，都需要编程做数据处理，就是栗子。 </p>
                <p> 如果孩子在中学毕业前，每周花几个小时，潜移默化，把大学计算机专业头两年的编程课程学完，不是虚头巴脑，而是实实在在开发出一堆App放在网上，那就是大学申请时的“独角兽”。再不济，能编个不错的网站，放上自己课外取得的成就，譬如音乐，绘画，舞蹈，体育什么的，既宣传了个性，又能表现出对编程的激情，对申请大学也一定会有益处。</p>
                <p> 所以孩子学编程，全是好处。如果您认同这想法，我们的石溪极限编程学校是一个选择。</p>
        ...
        <Slide left>
          ...
          <p> 编程是社会的方向。人工智能是大势，很多职业在被淘汰，而编程行业是一枝独秀，欣欣向荣。</p>
          <p> 不管孩子将来学什么，做什么，编程都有用。我的两个孩子大学毕业后做研究及工作，都需要编程做数据处理，就是栗子。 </p>
          <p> 如果孩子在中学毕业前，每周花几个小时，潜移默化，把大学计算机专业头两年的编程课程学完，不是虚头巴脑，而是实实在在开发出一堆App放在网上，那就是大学申请时的“独角兽”。再不济，能编个不错的网站，放上自己取得的成就，譬如音乐，绘画，舞蹈，体育什么的，既宣传了个性，又能表现出对编程的激情，对申请大学也一定会有益处。</p>
          <p> 所以孩子学编程，全是好处。如果您认同这想法，我们的石溪极限编程学校是一个选择。</p>
          <p> 我们学校是长岛第一家，也是唯一的一家全日制编程学校。老师是有二十多年教学经验的大学电脑系教授和年轻的在职程序猿。我们教AP Computer Science, 网页App开发,也教正式大学计算机系头两年的编程内容，从一张白纸开始，由易到难，带着您的孩子一步步往上走。</p>
          <p> 我们的教学以动手操作为主。因为是小班，所有的内容都是由老师带着孩子动手做，而且以做project为主，这样学生和家长都可以随时看到进步。</p>
          <p> 上课时间可以由家长讨论决定。另外，我们还有编程夏令营，孩子放暑假后可以天天来上课，一个夏天下来，能学很多东西。</p>

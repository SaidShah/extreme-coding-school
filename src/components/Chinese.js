          ...
          <div className="course-top-right-chinese">
            <Slide left>
              <p className="course-paragraph course-paragraph-left" style={{color:"white", width:"100%", textAlign:"left"}}>
                ...
                <p> 如果孩子在中学毕业前，每周花几个小时，潜移默化，把大学计算机专业头两年的编程课程学完，不虚头巴脑，实实在在开发出一堆App，那就是大学申请时的“独角兽”。再不济，要是自己能编个不错的网站，上面放上高中课外取得的成就，譬如音乐，绘画，舞蹈，体育什么的，既宣传了个性，又能表现出对编程的兴趣，对申请大学也一定会有益处。</p>

          ...
          <div className="course-top-right-chinese">
            <Slide left>
              <p className="course-paragraph course-paragraph-left" style={{color:"white", width:"100%", textAlign:"left"}}>
                ...
                <p> 编程是社会的方向。人工智能是大势所趋，很多职业在被淘汰，而编程这个行业在可预见的未来仍然会欣欣向荣。</p>
                <p> 何况不管孩子将来学什么，做什么，编程都有用。我的两个孩子大学毕业后做研究及工作，都需要编程做数据处理，就是栗子。 </p>
                <p> 如果孩子在中学毕业前，每周花几个小时，潜移默化，把大学计算机专业头两年的编程课程学完，不玩虚头巴脑的，开发出一堆App，那就是实实在在的“独角兽”，对申请大学肯定会有帮助。再不济，要是自己能编个不错的网站，上面放上高中课外取得的成就，譬如音乐，绘画，舞蹈，体育什么的，既宣传了个性，又能表现出对编程的兴趣，对申请大学也有益处。</p>
                <p> 所以孩子学编程，全是好处，没有坏处。如果您认同这想法，我们的极限编程学校是一个选择。</p>
                <p> 我们极限编程学校是长岛第一家，也是唯一的一家编程学校。老师是有二十多年教学经验，闲着也是闲着的大学电脑系教授和年轻的在职程序猿。我们教AP Computer Science, 网页App开发,也教正式大学计算机系头两年的编程内容，从一张白纸开始，由易到难，带着您的孩子一步步往上走。</p>
                <p> 我们的教学以动手操作为主。因为是小班，所有的内容都是由老师带着孩子动手做，而且以做project为主，这样学生和家长都可以随时看到成绩。</p>
                <p> 上课时间可以由家长讨论决定。另外，我们还有编程夏令营，孩子放暑假后可以天天来上课，一个夏天下来，能学很多东西。</p>
                <p> 我们也有编程集训营，十五周时间，天天强化培训，不过这个是给有兴趣转行做编程的成人准备的哈。</p>

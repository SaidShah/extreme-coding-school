          ...
          <div className="course-top-right-chinese">
            <Slide left>
              <p className="course-paragraph course-paragraph-left" style={{color:"white", width:"100%", textAlign:"left"}}>
                ...
                <p> 如果孩子能在中学毕业前，每周花几个小时，潜移默化，把大学计算机专业头两年的编程课程学完，不玩虚的，并开发出一堆App，那就是实实在在独树一帜，对申请大学肯定会有帮助。再不济，要是自己能编个不错的网站，上面放上高中课外取得的成就，譬如音乐，绘画，舞蹈，体育什么的，既宣传了个性，又能表现出对编程的兴趣，对申请大学也有益处。</p>
                <p> 所以孩子学编程，全是好处，没有坏处。如果您认同这想法，我们的极限编程学校是一个选择。</p>
                <p> 我们极限编程学校是长岛第一家，也是唯一的编程学校。老师是有二十多年教学经验，闲着也是闲着的大学教授和年轻的在职程序猿。我们教AP Computer Science, 网页App开发,也教正式大学计算机系头两年的编程内容，从一张白纸开始，由易到难，带着您的孩子一步步往上走。</p>

      ...
      <div className="intro-java-gradient" style={{paddingBottom:"1vw"}}>
          ...
          <div className="course-top-right">
            <Slide left>
              <p className="course-paragraph course-paragraph-left" style={{color:"white", width:"100%", textAlign:"left"}}>
                ...
                <p> 第一，长期看，编程是社会的方向。人工智能是大势所趋，很多职业在被淘汰，而编程这个行业在可预见的未来仍然会欣欣向荣。</p>
                <p> 第二，中期看，不管孩子将来学什么，做什么，编程都有用。我的两个孩子大学毕业后做研究及工作，都需要编程做数据处理，就是栗子。 </p>
                <p> 第三，近期看，如果孩子能在中学毕业前，把大学计算机专业头两年的编程课程上完，并开发出一堆App，我觉得对申请大学计算机专业有帮助。再不济，要是自己能编个不错的网站，上面放上高中课外取得的成就，譬如音乐，绘画，舞蹈，体育什么的，既宣传了个性，又能表现出对编程的兴趣，对申请大学也有益处。</p>
                <p> 如果您认同这想法，我们的极限编程学校就是学编程的一个选择。</p>
                <p> 极限编程学校教什么？</p>
                <p> 简单说，我们教AP Computer Science, 网页开发,也教正式大学计算机系头两年的编程内容，从一张白纸开始，由易到难，带着孩子一步步往上走。</p>
                <p> 极限编程学校教学方法是什么？</p>
                <p> 我们是以动手操作为主。因为是小班，所有的内容都是由老师带着孩子动手做，而且以做project为主，这样学生和家长都可以随时看到成绩。</p>
                <p> 极限编程学校的上课时间是什么？</p>
                <p> 时间可以由有兴趣的家长讨论决定。另外，我们还有编程夏令营，孩子放暑假后可以天天来上课，一个夏天下来，能学很多东西。</p>
                <p> 我们也有编程集训营，十五周时间，强化培训，不过这个是给有兴趣转行做编程的成人准备的。</p>
                <p> 极限编程学校对学生有年龄限制吗？</p>
                <p> 原则上没有，但孩子必须有兴趣，真正想学，所以估计得中学以上，不是客气，让我们几个男人开托儿所还真不行。</p>
        ...
        <Slide left>
          <p className="course-list" style={{color:"white", width:"100%", textAlign:"left", padding:"5vw"}}>
            <p> 时常有人问我，孩子课外应该学什么。我的建议是学编程。</p>
            <p> 第一，长期看，编程是社会的方向。人工智能是大势所趋，很多职业都在被淘汰，而编程这个行业在可预见的未来仍然会欣欣向荣。</p>
            <p> 第二，中期看，不管孩子将来学什么，做什么，编程都有用。我的两个孩子大学毕业后做研究及工作，都需要编程做数据处理，就是栗子。 </p>
            <p> 第三，近期看，如果孩子能在中学毕业前，把大学计算机专业头两年的编程课程上完，并开发出一堆App，俺觉得对申请大学计算机专业有帮助。再不济，要是自己能编个不错的网站，上面放上高中课外取得的成就，譬如音乐，绘画，舞蹈，体育什么的，既宣传了个性，又能表现出对编程的兴趣，对申请大学也有益处。</p>
            <p> 如果您认同这想法，我们的极限编程学校就是学编程的一个选择。</p>
            <p> 极限编程学校教什么？</p>
            <p> 简单说，我们教AP Computer Science, 网页开发,也教正式大学计算机系头两年的编程内容，从一张白纸开始，由易到难，带着孩子一步步往上走。</p>
            <p> 极限编程学校教学方法是什么？</p>
            ...
            <p> 我们也有编程集训营，十五周时间，强化培训，不过这个是给有兴趣转行做编程的成人准备的。</p>
            <p> 极限编程学校对学生有年龄限制吗？</p>
            <p> 原则上没有，但娃必须有兴趣，真正想学，所以估计得中学以上，不是客气，让我们几个男人开托儿所还真不行。</p>
            <p> 闲话休提，书归正传。下面是我们预计开设的一些课程，详细内容请看英文页面。</p>
          </p>
        </Slide>
      </div>

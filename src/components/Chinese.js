          ...
          <div className="course-top-right-chinese">
            <Slide left>
              <p className="course-paragraph course-paragraph-left" style={{color:"white", width:"100%", textAlign:"left"}}>
                ...
                <p> 还有，不管孩子将来学什么，做什么，编程都有用。我的两个孩子大学毕业后做研究及工作，都需要编程做数据处理，就是栗子。 </p>
                <p> 想想看，如果孩子能在中学毕业前，把大学计算机专业头两年的编程课程上完，并开发出一堆App，我觉得对申请大学计算机专业有帮助。再不济，要是自己能编个不错的网站，上面放上高中课外取得的成就，譬如音乐，绘画，舞蹈，体育什么的，既宣传了个性，又能表现出对编程的兴趣，对申请大学也有益处。</p>
                <p> 如果您认同这想法，我们的极限编程学校是一个选择。</p>
                <p> 我们极限编程学校教AP Computer Science, 网页开发,也教正式大学计算机系头两年的编程内容，从一张白纸开始，由易到难，带着孩子一步步往上走。</p>

          ...
          <div className="course-top-right">
            <Slide left>
              <p className="course-paragraph course-paragraph-left" style={{color:"white", width:"100%", textAlign:"left"}}>
                ...
                <p> 为什么呢？</p>
                <p> 第一，长远看，编程是社会的方向。人工智能是大势所趋，很多职业都在被淘汰，而编程这个行业在可预见的未来仍然会欣欣向荣。</p>
                <p> 第二，中期看，不管孩子将来学什么，做什么，编程都有用。我的两个孩子大学毕业后做研究及工作，都需要编程做数据处理，就是例子。 </p>
                <p> 第三，近期看，如果孩子能在中学毕业前，把大学计算机专业头两年的编程课程上完，并开发出一堆App，俺觉得对申请大学计算机专业有帮助。再不济，要是自己能编个不错的网站，上面放上自己高中课外取得的成就，譬如音乐，绘画，舞蹈，体育什么的，既宣传了自己的个性，又能表现出自己对编程的兴趣，对申请大学也有益处。</p>
                <p> 如果您认同这想法，我们的极限编程学校就是教孩子编程的一个选择。</p>
                <p> 极限编程学校教什么？</p>
